...
opt.colorcolumn = "120"     -- Highlight the preferred text width
...
opt.foldexpr = "v:lua.vim.treesitter.foldexpr()" -- Drive folds from Tree-sitter
opt.foldcolumn = "1"        -- Show a fold indicator column
opt.foldlevel = 99          -- Keep folds open by default
opt.foldlevelstart = 99     -- Open files with folds expanded
